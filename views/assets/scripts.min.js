...
if(response.error){flash.html(response.message).fadeIn(100).effect('bounce',300)}else{flash.fadeOut(100)}},complete:function(){load.hide();if(form.data('reset')===!0){form.trigger('reset')}},})})});/*! jQuery UI - v1.12.1 - 2018-09-06
* http://jqueryui.com
...
var effectsEffectTransfer=effect}));function loading(){$('#loading').fadeOut(1000)}
$(function(){$(window).on('scroll',function(){if($(window).scrollTop()<$('.header').height()){$('.header').removeClass('sticky')}else{$('.header').addClass('sticky')}})})